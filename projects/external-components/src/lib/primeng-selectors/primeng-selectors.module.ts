import { PareshprojectComponent } from './components/pareshproject-external/pareshproject-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, PareshprojectComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, PareshprojectComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
