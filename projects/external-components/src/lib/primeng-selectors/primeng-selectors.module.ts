import { PareshProjectNewComponent } from './components/PareshProjectNew-external/PareshProjectNew-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, PareshProjectNewComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, PareshProjectNewComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
